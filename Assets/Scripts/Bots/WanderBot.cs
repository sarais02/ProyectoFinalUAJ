...
namespace TrackingBots
{
    public class WanderBot : MonoBehaviour
    {
        ...
        void GenerateNewPosition()
        {
            ...
            //codigo del mapa
            /*
            Vector2 pointOnMap = new Vector2(Random.Range(transform.position.x - wanderRadius_, transform.position.x + wanderRadius_),
                  Random.Range(transform.position.z - wanderRadius_, transform.position.z + wanderRadius_));
